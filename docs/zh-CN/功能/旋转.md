...
NLC: 旋转 分组 Branch, Dept; 标题列 State; 取值列 Amount量; 计数
...
branch2	Sales	New York	15000
branch3	Sales	Texas	12000
NLC: 旋转 分组 分公司 命名 Branch, Dept; 标题列 State; 取值列 Amount量; 逆向
参数：**表头 <自定义标题列名>**
...
NLC: 旋转 分组 Branch, Dept; 标题列 State; 取值列 Amount量; 表头 FState,Cstate,NState,TState,PState
结果：
